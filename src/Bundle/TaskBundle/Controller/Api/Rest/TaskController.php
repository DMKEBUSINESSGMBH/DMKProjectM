...
namespace DMKProjectM\Bundle\TaskBundle\Controller\Api\Rest;
...
class TaskController extends RestController implements ClassResourceInterface
{
     ...
     *      resource=true
     * )
     * @AclAncestor("projectm_task_update")
     * @return Response
     */
     ...
     *      resource=true
     * )
     * @AclAncestor("projectm_task_create")
     */
    ...
    {
        return $this->get('projectm_task.manager.api');
    }
    ...
    {
        return $this->get('projectm_task.form.api');
    }
    ...
    {
        return $this->get('projectm_task.form.handler.task_api');
    }
