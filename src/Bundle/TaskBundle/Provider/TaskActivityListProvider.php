...
{
    const ACTIVITY_CLASS = 'DMKProjectM\Bundle\TaskBundle\Entity\Task';
    const ACL_CLASS = 'DMKProjectM\Bundle\TaskBundle\Entity\Task';
    ...
    {
        return 'DMKProjectMTaskBundle:Task:js/activityItemTemplate.html.twig';
    }
